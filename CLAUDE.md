...
- **One stylesheet** (`assets/css/style.css`). Colors are tokens at the top; dark mode only redefines the tokens. Dark backgrounds stay near-neutral, green is only the accent.
